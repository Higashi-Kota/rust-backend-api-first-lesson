...
impl TaskRepository {
    ...
    pub async fn find_by_id_for_user(
        ...
        TaskEntity::find_by_id(id)
            .filter(crate::features::task::models::task_model::Column::UserId.eq(user_id))
            .one(&self.db)
            .await
    }
    ...
    pub async fn find_all(
        &self,
    ) -> Result<Vec<crate::features::task::models::task_model::Model>, DbErr> {
        self.prepare_connection().await?;
        TaskEntity::find()
            .order_by_desc(crate::features::task::models::task_model::Column::CreatedAt)
            .all(&self.db)
            .await
    }
    ...
    pub async fn find_with_filter(
    ...
    ) -> Result<(Vec<crate::features::task::models::task_model::Model>, u64), DbErr> {
        self.prepare_connection().await?;
        ...
        if let Some(status) = &filter.status {
            conditions = conditions
                .add(crate::features::task::models::task_model::Column::Status.eq(status.as_str()));
        }

        // タイトル検索
        if let Some(title_contains) = &filter.title_contains {
            conditions = conditions.add(
                crate::features::task::models::task_model::Column::Title.contains(title_contains),
            );
        }
        ...
        if let Some(desc_contains) = &filter.description_contains {
            conditions = conditions.add(
                crate::features::task::models::task_model::Column::Description
                    .contains(desc_contains),
            );
        }
        ...
        if let Some(due_before) = filter.due_date_before {
            conditions = conditions
                .add(crate::features::task::models::task_model::Column::DueDate.lt(due_before));
        }

        if let Some(due_after) = filter.due_date_after {
            conditions = conditions
                .add(crate::features::task::models::task_model::Column::DueDate.gt(due_after));
        }

        // 作成日フィルタ
        if let Some(created_after) = filter.created_after {
            conditions = conditions.add(
                crate::features::task::models::task_model::Column::CreatedAt.gt(created_after),
            );
        }

        if let Some(created_before) = filter.created_before {
            conditions = conditions.add(
                crate::features::task::models::task_model::Column::CreatedAt.lt(created_before),
            );
        }
        ...
        match filter.sort_by.as_deref() {
            Some("title") => {
                query = query.order_by(
                    crate::features::task::models::task_model::Column::Title,
                    sort_order,
                )
            }
            Some("due_date") => {
                query = query.order_by(
                    crate::features::task::models::task_model::Column::DueDate,
                    sort_order,
                )
            }
            Some("created_at") => {
                query = query.order_by(
                    crate::features::task::models::task_model::Column::CreatedAt,
                    sort_order,
                )
            }
            Some("status") => {
                query = query.order_by(
                    crate::features::task::models::task_model::Column::Status,
                    sort_order,
                )
            }
            _ => {
    ...
    pub async fn find_with_filter_for_user(
        ...
        let mut query = TaskEntity::find();
        let mut conditions = Condition::all()
            .add(crate::features::task::models::task_model::Column::UserId.eq(user_id)); // ユーザーフィルタを追加
    ...
    pub async fn delete_for_user(&self, user_id: Uuid, id: Uuid) -> Result<DeleteResult, DbErr> {
        ...
        TaskEntity::delete_many()
            .filter(crate::features::task::models::task_model::Column::Id.eq(id))
            .filter(crate::features::task::models::task_model::Column::UserId.eq(user_id))
            .exec(&self.db)
            .await
    }
    ...
    pub async fn delete_many(&self, ids: Vec<Uuid>) -> Result<DeleteResult, DbErr> {
        ...
        TaskEntity::delete_many()
            .filter(crate::features::task::models::task_model::Column::Id.is_in(ids))
            .exec(&self.db)
            .await
    }
    ...
    pub async fn count_tasks_by_status(&self, status: &str) -> Result<u64, DbErr> {
        self.prepare_connection().await?;
        TaskEntity::find()
            .filter(crate::features::task::models::task_model::Column::Status.eq(status))
            .count(&self.db)
            .await
    }
    ...
    pub async fn get_priority_distribution(&self) -> Result<Vec<(String, u64)>, DbErr> {
        ...
        let result = TaskEntity::find()
            .select_only()
            .column(crate::features::task::models::task_model::Column::Priority)
            .column_as(
                Expr::col(crate::features::task::models::task_model::Column::Id).count(),
                "count",
            )
            .group_by(crate::features::task::models::task_model::Column::Priority)
    ...
    pub async fn get_average_completion_days_by_priority(
        ...
        for priority in priorities {
            let tasks = TaskEntity::find()
                ...
                .filter(crate::features::task::models::task_model::Column::Priority.eq(priority))
                .filter(
                    crate::features::task::models::task_model::Column::CompletedAt.is_not_null(),
                )
                .all(&self.db)
                .await?;
    ...
    pub async fn get_weekly_trend_data(
        ...
        for week in 0..weeks {
            ...
            let created_count = TaskEntity::find()
                .filter(
                    crate::features::task::models::task_model::Column::CreatedAt.gte(week_start),
                )
                .filter(crate::features::task::models::task_model::Column::CreatedAt.lt(week_end))
                .count(&self.db)
                .await?;
            ...
            let completed_count = TaskEntity::find()
                .filter(
                    crate::features::task::models::task_model::Column::CompletedAt.gte(week_start),
                )
                .filter(crate::features::task::models::task_model::Column::CompletedAt.lt(week_end))
                .count(&self.db)
                .await?;
    ...
    pub async fn get_user_average_completion_hours(&self, user_id: Uuid) -> Result<f64, DbErr> {
        ...
        let completed_tasks = TaskEntity::find()
            .filter(crate::features::task::models::task_model::Column::UserId.eq(user_id))
            .filter(crate::features::task::models::task_model::Column::Status.eq("completed"))
            .filter(crate::features::task::models::task_model::Column::CompletedAt.is_not_null())
            .all(&self.db)
            .await?;
