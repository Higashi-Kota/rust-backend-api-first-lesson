// src/features/user/models/user.rs
...
pub enum Relation {
    #[sea_orm(
        has_many = "crate::features::task::models::task_model::Entity",
        from = "Column::Id",
        to = "crate::features::task::models::task_model::Column::UserId"
    )]
    Tasks,

    #[sea_orm(has_many = "crate::features::auth::models::refresh_token::Entity")]
    RefreshTokens,

    #[sea_orm(has_many = "crate::features::auth::models::password_reset_token::Entity")]
    PasswordResetTokens,

    #[sea_orm(
        belongs_to = "crate::features::security::models::role::Entity",
        from = "Column::RoleId",
        to = "crate::features::security::models::role::Column::Id"
    )]
    Role,
...
// リレーション実装
impl Related<crate::features::task::models::task_model::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::Tasks.def()
    }
}

impl Related<crate::features::auth::models::refresh_token::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::RefreshTokens.def()
    }
}

impl Related<crate::features::auth::models::password_reset_token::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::PasswordResetTokens.def()
    }
}

impl Related<crate::features::security::models::role::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::Role.def()
    }
}
    ...
    fn from(claims: UserClaims) -> Self {
        let role = claims.role.unwrap_or_else(|| {
            ...
            let role_name = match claims.role_name.as_str() {
                "admin" => crate::features::security::models::role::RoleName::Admin,
                _ => crate::features::security::models::role::RoleName::Member,
            };
