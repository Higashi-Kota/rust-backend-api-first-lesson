...
pub enum Relation {
    #[sea_orm(
        belongs_to = "crate::features::task::models::task_attachment_model::Entity",
        from = "Column::AttachmentId",
        to = "crate::features::task::models::task_attachment_model::Column::Id",
        on_update = "NoAction",
        on_delete = "Cascade"
    )]
    TaskAttachment,
...
impl Related<crate::features::task::models::task_attachment_model::Entity> for Entity {
    fn to() -> RelationDef {
